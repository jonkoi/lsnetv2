...
\begin{figure*}
  \begin{tabularx}{\textwidth}{cccc}
  \centering
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_base_imgs/.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_gt/.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_old/.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_new/.png}}\\
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_base_imgs/.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_gt/.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_old/.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_new/.png}}\\
