...
% LSNetv2     & modified VGG     & 0.696 & 0.566 & 0.624 & 0.683       & 10.0      \\
% LSNetv2     & Resnet-50        & 0.643 & 0.635 & 0.639 & 0.642       & 12.8      \\
% LSNetv2     & Efficientnetv2-M & 0.573 & 0.355 & 0.438 & 0.545       & 14.5      \\
% LSNetv2     & ConvNext-Tiny    & 0.714 & 0.560 & 0.628 & 0.698       & 13.9     
% \end{tabular}
...
%   LSNet   & modified VGG                                   & 0.579    & 0.525    & 0.551       & 0.565          & 0.917         & 0.887        & 0.902        & 0.086          \\
%   LSNetv2 & modified VGG                                   & 0.696    & 0.566    & 0.624       & 0.661          & 0.723         & 0.964        & 0.827        & 0.224          \\
...
%   \hline
%                              & Backbone                       & APR                        & ARR                        & F1                         & Fbeta                      & param \\ \hline
%   \multicolumn{1}{l|}{AFM}   & \multicolumn{1}{l|}{UNET}      & \multicolumn{1}{l|}{0.495} & \multicolumn{1}{l|}{0.432} & \multicolumn{1}{l|}{0.457} & \multicolumn{1}{l|}{0.498} & 44.0  \\ \hline
%   \multicolumn{1}{l|}{LCNN}  & \multicolumn{1}{l|}{Hourglass} & \multicolumn{1}{l|}{0.541} & \multicolumn{1}{l|}{0.464} & \multicolumn{1}{l|}{0.315} & \multicolumn{1}{l|}{0.498} & 10,9  \\ \hline
%   \multicolumn{1}{l|}{HAWP}  & \multicolumn{1}{l|}{Hourglass} & \multicolumn{1}{l|}{0.581} & \multicolumn{1}{l|}{0.421} & \multicolumn{1}{l|}{0.485} & \multicolumn{1}{l|}{0.532} & 11.6  \\ \hline
%   \multicolumn{1}{l|}{PLGAN} & \multicolumn{1}{l|}{Resnet-6}  & \multicolumn{1}{l|}{0.863} & \multicolumn{1}{l|}{0.577} & \multicolumn{1}{l|}{0.687} & \multicolumn{1}{l|}{0.769} & 14.9  \\ \hline
%   LSNetv2                    & ConvNext-Tiny                  & 0.717                      & 0.6079904                  & 0.658                      & 0.688                      & 20.2  \\ \hline
%   \end{tabular}
%   \end{table}
...
\begin{figure*}
  \begin{tabularx}{\textwidth}{cccc}
  \centering
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_base_imgs/4.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_gt/4.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_old/4.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_new/4.png}}\\
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_base_imgs/24.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_gt/24.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_old/24.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_new/24.png}}\\
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_base_imgs/18.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_gt/18.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_old/18.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/pldm_new/18.png}}\\
...
\begin{figure*}
  \begin{tabularx}{\textwidth}{cccc}
  \centering
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_base_imgs/107_1410_2.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_gt/107_1410_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_old/107_1410_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_new/107_1410_2.png}}\\
  ...
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_base_imgs/14_00486_2.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_gt/14_00486_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_old/14_00486_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_new/14_00486_2.png}}\\
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_base_imgs/23_00706_2.jpg}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_gt/23_00706_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_old/23_00706_2.png}} &
  \subfloat{\includegraphics[width = 1.65in]{imgs/ttpla_new/23_00706_2.png}}\\
...
\begin{figure*}
  ...
  \centering
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_base_imgs/Dalane__Dalane+IA__DAT_7909.JPG}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_gt/Dalane__Dalane+IA__DAT_7909.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_old/Dalane__Dalane+IA__DAT_7909.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_old/Dalane__Dalane+IA__DAT_7909.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_new/Dalane__Dalane+IA__DAT_7909.png}}\\
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_base_imgs/Alta__a1cf5776-0454-4ef6-8726-ad25b0023293.JPG}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_gt/Alta__a1cf5776-0454-4ef6-8726-ad25b0023293.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_old/Alta__a1cf5776-0454-4ef6-8726-ad25b0023293.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_old/Alta__a1cf5776-0454-4ef6-8726-ad25b0023293.png}} &
  \subfloat{\includegraphics[width = 1.25in]{imgs/esmart_new/Alta__a1cf5776-0454-4ef6-8726-ad25b0023293.png}}\\
  % Add caption row
  Image & Ground truth & LSNet & LSNetv2
  % \subfloat[caption]{\includegraphics[width = 1.5in]{something}}\\
  \end{tabularx}
